...
\caption{
  ...
  There can be only one parent, though the child lineages may be in demes different from those of their parent.
  ...
  The production of this event is $r=(0,0)$.
  ...
  Accordingly, its production is $r=(1,1)$.
  \textbf{(E)} A neutral-type event has no effect on the genealogy and zero production in all demes: $r=(0,0)$.
  ...
  The production of this event is $r=(2,0)$.
  \textbf{(G)} Here, a compound sample/death-type event with $r=(0,0)$ occurs.
  ...
  \textbf{(H)} A compound birth/migration-type event with $r=(4,0)$.
