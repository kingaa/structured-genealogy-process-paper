...
\begin{table}[h!]
  ...
  \begin{tabular}{cclc}
    ...
    \hline
    $\lab{Trans}$  & ${\beta S I}/{N}$ & pure birth  & 2 \\
    $\lab{Recov}$  & $\gamma I$        & pure death  & 0 \\
    $\lab{Wane}$   & $\omega R$        & neutral     & 0 \\
    $\lab{Sample}$ & $\psi I$          & pure sample & 1 \\
    \hline\hline
  \end{tabular}
\end{table}
...
\begin{table}[h!]
  ...
  \begin{tabular}{cclc}
    ...
    $u$ & $\alpha_u$ & Event type & $r_u$ \\
    \hline
    $\lab{Trans}$  & ${\beta S I}/{N}$ & pure birth     & $(1,1)$ \\
    $\lab{Prog}$   & $\sigma E$        & pure migration & $(0,1)$ \\
    $\lab{Recov}$  & $\gamma I$        & pure death     & $(0,0)$ \\
    $\lab{Wane}$   & $\omega R$        & neutral        & $(0,0)$ \\
    $\lab{Sample}$ & $\psi I$          & pure sample    & $(0,1)$ \\
    \hline\hline
  \end{tabular}
\end{table}
