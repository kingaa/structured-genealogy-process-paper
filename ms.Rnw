...
\begin{table}
  ...
  \begin{tabular}{c c c c c c c c | c}
    ...
    & $(0,0)$ & 1 & $\left(\frac{E-\ell_E}{E}\right)\left(\frac{I-\ell_I}{I}\right)$ \bigstrut & \unbroken \bigstrut & $\frac{I+1-\ell_I}{I+1}$ & 1 & 1 \\
    \cline{3-8}
    && $(1,0)$ & 1 & $\frac{I-\ell_I}{E I}$ \bigstrut & \maizeblue \bigstrut & $\frac{1}{2(I+1)}$ & $\ell_I$ & 2 \\
    \cline{3-8}
    && $(0,1)$ & 1 & $\frac{E-\ell_E}{E I}$ \bigstrut & \maizemaize \bigstrut & $\frac{1}{2(I+1)}$ & $\ell_I$ & 3 \\
    \cline{3-8}
    && $(1,1)$ & 0 & & & & 0 & 4 \\
    \cline{2-8}
    &\multirow{2}{*}{$\lab{Prog}$}
    & $(0,0)$ & 1 & $\frac{I-\ell_I}{I}\,\Indicator{E\ge\ell_E}$ \bigstrut & \unbroken \bigstrut & $\frac{E+1-\ell_E}{E+1}\,\Indicator{E>\ell_E}$ \bigstrut & 1 & 5 \\
    \cline{3-8}
    && $(0,1)$ & 1 & $\frac{1}{I}\,\Indicator{E\ge\ell_E}$ \bigstrut & \bluemaize \bigstrut & $\frac{1}{E+1}\,\Indicator{E>\ell_E}$ \bigstrut & $\ell_E$ & 6 \\
    \cline{2-8}
