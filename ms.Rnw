...
\begin{enumerate}[(a)]
  ...
  \item \label{item:M2Z} If $t_k\in(a_q,s_q)\setminus\Masterset(\Och_{q-1})$, $t_k\in\Zset^{j,j'}(\Och_q)$, and $u_k\in\Mset^{j,j'}$, then there was a migration event at time $t_k$ and the $q$-th sample lineage was involved. 
  ...
  Thus, at time $t_k$, one of the $I_{k-1}^{j}-\ell_{q,k-1}^{j}$ individuals was chosen to migrate and right after, among $I_{k}^{j'}-\ell_{qk}^{j'}$ unobserved individuals, the $q$-th sample was the exact one just migrated.
  ...
  \item
  \item If $t_k\in(a_q,s_q)\setminus\Masterset(\Och_{q-1})$, $t_k\in\Zset^{j,j'}(\Och_q)$, and $u_k\in\Bset^{j,j'}$, then there was a birth event at time $t_k$ and the $q$-th sample lineage was involved. 
    ...
    Among all these combinations, the $q$-th sample lineage was exactly the black ball newly added to Deme $j'$ after the birth event.
