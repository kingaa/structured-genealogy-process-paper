...
To date, however, computation of this likelihood function has been out of reach, except in several special cases.
...
In particular, existing approaches to likelihood-based phylodynamic inference have been based on one of two mathematical idealizations.
...
Extensions of this approach develop approximations via linearization of nonlinear processes or restriction to scenarios in which population growth is nearly linear \citep{MacPherson2021}.
